...
class EnderecosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create endereco" do
    assert_difference('Endereco.count') do
      post enderecos_url, params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, ibge: @endereco.ibge, logradouro: @endereco.logradouro, municipe_id: @endereco.municipe_id, uf: @endereco.uf } }
    end
  ...
  test "should update endereco" do
    patch endereco_url(@endereco), params: { endereco: { bairro: @endereco.bairro, cep: @endereco.cep, cidade: @endereco.cidade, complemento: @endereco.complemento, ibge: @endereco.ibge, logradouro: @endereco.logradouro, municipe_id: @endereco.municipe_id, uf: @endereco.uf } }
